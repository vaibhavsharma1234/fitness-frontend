<template>
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Become a Fitness Influencer</h2>
          <p class="mt-6 text-lg leading-8 text-gray-300">Do you have a passion for fitness? Join us as a fitness influencer and help others achieve their fitness goals.</p>
        </div>
        <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          <div class="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
            <a href="#" class="hover:text-[#ff4694]">Learn more <span aria-hidden="true">&rarr;</span></a>
          </div>
  ...
  <script setup>
  const stats = [
    { name: 'Influencers', value: '100+' },
    { name: 'Workout Plans', value: '50+' },
    { name: 'Diet Plans', value: '30+' },
